...
namespace MarsQA_1.SpecflowPages.Pages
{
    class ShareSkill
    {
        ...
        internal void GotoShareSkill()
        {
            ...
            WaitHelpers.WaitForElementVisibility(Driver.driver, "LinkText", "Share Skill", 50);
        ...
        internal void AddShareSkill()
        {
            ...
            try
            {
                ...
                WaitHelpers.WaitForElementVisibility(Driver.driver, "Name", "description", 50);
                Description.Click();
                Description.Clear();
                ...
                WaitHelpers.WaitForElementVisibility(Driver.driver, "Name", "categoryId", 50);
                CategoryDropDown.Click();
                new SelectElement(CategoryDropDown).SelectByText(ExcelLibHelper.ReadData(2, "Category"));

                //Select catagory from drop down
                WaitHelpers.WaitForElementVisibility(Driver.driver, "Name", "subcategoryId", 50);
                ...
                WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//input[@value='']", 50);
                Tags.Click();
                Tags.Clear();
                ...
                {
                    WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//form/div[5]/div[@class='twelve wide column']/div/div[@class='field']", 50);
                ...
                {
                    WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//form/div[6]/div[@class='twelve wide column']/div/div[@class = 'field']", 50);
              ...
              //  EndDateDropDown.SendKeys("01/10/2021");
                ...
                WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//body/div/div/div[@id='service-listing-section']/div[@class='ui container']/div[@class='listing']/form[@class='ui form']/div[7]/div[2]/div[1]", 50);
                Days.Click();
                Mon.Click();
                Tue.Click();
                Wed.Click();
                ...
                WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='service-listing-section']/div[2]/div/form/div[7]/div[2]/div/div[3]/div[2]/input", 50);
                StartTimeM.Click();
                ...
                WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='service-listing-section']/div[2]/div/form/div[7]/div[2]/div/div[4]/div[2]/input", 50);
                StartTimeT.Click();
                ...
                WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='service-listing-section']/div[2]/div/form/div[7]/div[2]/div/div[5]/div[2]/input", 50);
                StartTimeW.Click();
                ...
                WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='service-listing-section']/div[2]/div/form/div[7]/div[2]/div/div[6]/div[2]/input", 50);
                StartTimeTh.Click();
                ...
                WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='service-listing-section']/div[2]/div/form/div[7]/div[2]/div/div[3]/div[3]/input", 50);
                EndTimeM.Click();
                ...
                WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='service-listing-section']/div[2]/div/form/div[7]/div[2]/div/div[4]/div[3]/input", 50);
                EndTimeT.Click();
                ...
                WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='service-listing-section']/div[2]/div/form/div[7]/div[2]/div/div[5]/div[3]/input", 50);
                EndTimeW.Click();
                ...
                WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='service-listing-section']/div[2]/div/form/div[7]/div[2]/div/div[6]/div[3]/input", 50);
                EndTimeTh.Click();
                ...
                {
                    WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//form/div[8]/div[@class='twelve wide column']/div/div[@class='field']", 50);
                    SkillTradeOption.Click();

                    //Add Skill exchange tag
                    WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='service-listing-section']/div[2]/div/form/div[8]/div[4]/div/div/div/div/div/input", 50);
                    SkillExchange.Click();
                    SkillExchange.Clear();
                ...
                else if (ExcelLibHelper.ReadData(2, "SkillTrade") == "Credit")
                {
                    ...
                    //Addcredit amount
                    WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='service-listing-section']/div[2]/div/form/div[8]/div[4]/div/div/input", 50);
                    CreditAmount.Click();
                    CreditAmount.Clear();
                ...
                {
                    WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//form/div[10]/div[@class='twelve wide column']/div/div[@class = 'field']", 50);
                    ActiveOption.Click();
                }
        ...
        internal void VerifySkill()
        {
           ...
           WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id=\"listing-management-section\"]/div[2]/div[1]/div[2]/button[2]", 50);
            ManageLis.Click();
            ...
            try
            {
                ...
                WaitHelpers.WaitForElement(Driver.driver, "XPath", "//*[@id='listing-management-section']/div[2]/div[1]/div[1]/table/tbody/tr[1]/td[2]", 50);
                ...
                WaitHelpers.WaitForElement(Driver.driver, "XPath", "//*[@id='listing-management-section']/div[2]/div[1]/div[1]/table/tbody/tr[1]/td[3]", 50);
