...
namespace MarsQA_1.SpecflowPages.Pages
{
    class ManageRequest
    {
        ...
        internal void ManageRequests()
        {
            ...
            WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//div[text()='Manage Requests']", 50);
            ManageReqTab.Click();
        }
        ...
        internal void ReceviedRequests()
        {
            ...
            WaitHelpers.WaitForElementVisibility(Driver.driver, "LinkText", "Received Requests", 50);
        ...
        internal void ResponseRequests()
        {
            ...
            {
                WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='received-request-section']/div[2]/div[1]/table/tbody/tr[1]/td[8]/button[1]", 50);
                AcceptRequest.Click();
            }
            else if (ExcelLibHelper.ReadData(2, "ReceviedRequest") == "Decline")
            {
                WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='received-request-section']/div[2]/div[1]/table/tbody/tr[1]/td[8]/button[2]", 50);
                DeclineRequest.Click();

            }

            //Complete request
            WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='received-request-section']/div[2]/div[1]/table/tbody/tr[3]/td[8]/button", 50);
        ...
        internal void SentRequests()
        {
            ...
            WaitHelpers.WaitForElementVisibility(Driver.driver, "LinkText", "Sent Requests", 50);
            SentReqstSel.Click();
        }
        ...
        internal void SentARequest()
        {
            ...
            Thread.Sleep(1000);
            //Enter name
            WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='service-search-section']/div[2]/div/section/div/div[1]/div[3]/div[1]/div/div[1]/input", 50);
            SearchNameicon.SendKeys(ExcelLibHelper.ReadData(2, "SearchName"));
            //SearchNameicon.SendKeys("kimi wang");
            Thread.Sleep(1000);

            //Select name
            WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='service-search-section']/div[2]/div/section/div/div[1]/div[3]/div[1]/div/div[2]/div[1]/div/span", 50);
            SearchName.Click();

            //Click on image
            WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='service-search-section']/div[2]/div/section/div/div[2]/div/div[2]/div/div/div[last()]/a/img", 50);
            SelName.Click();

            //Enter text data
            WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='service-detail-section']/div[2]/div/div[2]/div[2]/div[2]/div/div[2]/div/div[1]/textarea", 50);
            SearchNameicon.SendKeys(ExcelLibHelper.ReadData(2, "Text"));
            //textArea.SendKeys("I am interested on your skills");

            //Click on request
            WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "//*[@id='service-detail-section']/div[2]/div/div[2]/div[2]/div[2]/div/div[2]/div/div[3]", 50);
            SelRequest.Click();
            Thread.Sleep(1000);

            //select ok
            WaitHelpers.WaitForElementVisibility(Driver.driver, "XPath", "/html/body/div[4]/div/div[3]/button[1]", 50);
            Yes.Click();
